...
// Function to download a blob and save it as a file
...
// Handle PrintScreen event to capture and save a screenshot
...
// Event listener for PrintScreen key
...
function App() {
  useEffect(() => {
    let term: any; // Declare term outside the async function
    ...
    async function initialize() {
      ...
      // Initialize the terminal after the component has mounted
      $(document).ready(() => {
        term = $('#terminal').terminal(async (command: string) => {
